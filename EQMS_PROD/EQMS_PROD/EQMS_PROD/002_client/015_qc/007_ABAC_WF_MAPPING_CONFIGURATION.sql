...
(VAR_TENANT_KEY, VAR_ORG_ID, 415, 65, 1, NOW(), 1, NULL, NULL),
(VAR_TENANT_KEY, VAR_ORG_ID, 414, 66, 1, NOW(), 1, NULL, NULL),
--Incoming Inspection (Form 136) - Controls 418-421
(VAR_TENANT_KEY, VAR_ORG_ID, 420, NULL, 1, NOW(), 1, NULL, NULL),
(VAR_TENANT_KEY, VAR_ORG_ID, 421, 64, 1, NOW(), 1, NULL, NULL),
(VAR_TENANT_KEY, VAR_ORG_ID, 419, 66, 1, NOW(), 1, NULL, NULL),
(VAR_TENANT_KEY, VAR_ORG_ID, 418, 65, 1, NOW(), 1, NULL, NULL);
