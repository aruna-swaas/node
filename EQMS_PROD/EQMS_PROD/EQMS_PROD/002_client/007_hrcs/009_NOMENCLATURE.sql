...
(VAR_TENANT_KEY, VAR_ORG_ID, 51, 173, 'organization.eqms_organization_employee', 'id', 1, NOW(), 1),
(VAR_TENANT_KEY, VAR_ORG_ID, 52, 177, 'hrcs.eqms_hr_employee_training_evaluation', 'id', 1, NOW(), 1),
(VAR_TENANT_KEY, VAR_ORG_ID, 53, 181, 'organization.eqms_organization_employee', 'id', 1, NOW(), 1),
(VAR_TENANT_KEY, VAR_ORG_ID, 54, 185, 'organization.eqms_organization_employee', 'id', 1, NOW(), 1),
...
(VAR_TENANT_KEY, VAR_ORG_ID, 57, 197, 'organization.eqms_organization_employee', 'id', 1, NOW(), 1),
(VAR_TENANT_KEY, VAR_ORG_ID, 58, 201, 'organization.eqms_organization_employee', 'id', 1, NOW(), 1),
...
(VAR_TENANT_KEY, VAR_ORG_ID, 51, 51, 1, 1, 'organization.eqms_organization_employee', 'id', 'id', 1, NOW(), 1),
(VAR_TENANT_KEY, VAR_ORG_ID, 52, 52, 1, 1, 'hrcs.eqms_hr_employee_training_evaluation', 'id', 'id', 1, NOW(), 1),
(VAR_TENANT_KEY, VAR_ORG_ID, 53, 53, 1, 1, 'organization.eqms_organization_employee', 'id', 'id', 1, NOW(), 1),
(VAR_TENANT_KEY, VAR_ORG_ID, 54, 54, 1, 1, 'organization.eqms_organization_employee', 'id', 'id', 1, NOW(), 1),
...
(VAR_TENANT_KEY, VAR_ORG_ID, 57, 57, 1, 1, 'organization.eqms_organization_employee', 'id', 'id', 1, NOW(), 1),
(VAR_TENANT_KEY, VAR_ORG_ID, 58, 58, 1, 1, 'organization.eqms_organization_employee', 'id', 'id', 1, NOW(), 1),
