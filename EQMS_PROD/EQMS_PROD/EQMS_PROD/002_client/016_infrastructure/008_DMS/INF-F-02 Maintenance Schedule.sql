...
(55, VAR_TENANT_KEY, VAR_ORG_ID, 'record_generation_maintenance_plan', 1, NOW(), 1);
...
(VAR_TENANT_KEY, VAR_ORG_ID, 54, 149, 1, NOW(), 1);
...
(VAR_TENANT_KEY, VAR_ORG_ID, 882, 'eqms_infrastructure', 'infrastructure_name', NULL, 1, 1, NOW(), '{"id" : "@infrastructure_id"}');
...
(VAR_TENANT_KEY, VAR_ORG_ID, 887, 'eqms_maintenance_plan_detail', 'maintenance_description', NULL, 1, 1, NOW()),
...
(VAR_TENANT_KEY, VAR_ORG_ID, 888, 'eqms_maintenance_plan', 'id', NULL, 1, 1, NOW()),
(VAR_TENANT_KEY, VAR_ORG_ID, 888, 'eqms_maintenance_plan_equipments', 'id', NULL, 1, 1, NOW()),
(VAR_TENANT_KEY, VAR_ORG_ID, 888, 'eqms_maintenance_plan_skill_mapper', 'id', NULL, 1, 1, NOW()),
(VAR_TENANT_KEY, VAR_ORG_ID, 888, 'eqms_maintenance_plan_tools', 'id', NULL, 1, 1, NOW());

-- infrastructure_type_name (single, text)
INSERT INTO dms.eqms_document_template_variable (
    eqms_tenant_key, fk_eqms_organization_id, variable_key, fk_eqms_document_template_id, variable_identifier, status, created_by, created_date, ref_id
) VALUES 
(VAR_TENANT_KEY, VAR_ORG_ID, 'infrastructure_type_name', 54, '{infrastructure_type_name}', 1, 1, NOW(), 889);

INSERT INTO dms.eqms_document_template_variable_transformation_rules (
    eqms_tenant_key, fk_eqms_organization_id, fk_eqms_document_template_variable_id, fk_eqms_document_variable_operation_id, "order", status, created_date, created_by
) VALUES 
(VAR_TENANT_KEY, VAR_ORG_ID, 889, 10, 1, 1, NOW(), 1);

INSERT INTO dms.eqms_document_variable_mapper (
    eqms_tenant_key, fk_eqms_organization_id, fk_eqms_document_template_variable_id, form_table_name, form_column_name, value_type, status, created_by, created_date
) VALUES 
(VAR_TENANT_KEY, VAR_ORG_ID, 889, 'eqms_infrastructure_type_lk', 'infrastructure_type_name', NULL, 1, 1, NOW());
