...
REVOKE SELECT, INSERT, UPDATE, DELETE ON TABLE dnd.eqms_pilot_clinical_evaluation_plan_history FROM dnd_app_user;
REVOKE SELECT, INSERT, UPDATE, DELETE ON TABLE dnd.eqms_pilot_clinical_evaluation_plan FROM dnd_app_user;
