...
REVOKE SELECT, INSERT, UPDATE, DELETE ON TABLE organization.eqms_license_status_lk FROM dnd_app_user;
REVOKE SELECT, INSERT, UPDATE, DELETE ON TABLE dnd.eqms_license_initiation_history FROM dnd_app_user;
REVOKE SELECT, INSERT, UPDATE, DELETE ON TABLE dnd.eqms_license_initiation FROM dnd_app_user;
