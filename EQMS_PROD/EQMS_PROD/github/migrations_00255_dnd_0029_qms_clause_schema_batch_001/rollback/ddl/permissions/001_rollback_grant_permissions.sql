...
REVOKE SELECT, INSERT, UPDATE, DELETE ON TABLE dnd.eqms_product_applicable_clause_history FROM dnd_app_user;
REVOKE SELECT, INSERT, UPDATE, DELETE ON TABLE dnd.eqms_product_applicable_clause FROM dnd_app_user;
