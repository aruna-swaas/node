...
REVOKE SELECT, INSERT, UPDATE, DELETE ON TABLE risk_management.eqms_rm_before_mitigation_matrix_history FROM risk_app_user;
REVOKE SELECT, INSERT, UPDATE, DELETE ON TABLE risk_management.eqms_rm_before_mitigation_matrix FROM risk_app_user;
