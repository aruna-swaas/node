...
REVOKE SELECT, INSERT, UPDATE, DELETE ON TABLE dnd.eqms_pilot_clinical_evaluation_report_history FROM dnd_app_user;
REVOKE SELECT, INSERT, UPDATE, DELETE ON TABLE dnd.eqms_pilot_clinical_evaluation_report FROM dnd_app_user;
