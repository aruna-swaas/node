...
REVOKE SELECT, INSERT, UPDATE, DELETE ON TABLE risk_management.eqms_rmp_production_post_production_info_history FROM risk_app_user;
REVOKE SELECT, INSERT, UPDATE, DELETE ON TABLE risk_management.eqms_rmp_production_post_production_info FROM risk_app_user;
