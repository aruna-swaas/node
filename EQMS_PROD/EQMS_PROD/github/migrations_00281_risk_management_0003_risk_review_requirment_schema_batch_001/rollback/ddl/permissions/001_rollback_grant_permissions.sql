...
REVOKE SELECT, INSERT, UPDATE, DELETE ON TABLE risk_management.eqms_risk_review_requirment_history FROM risk_app_user;
REVOKE SELECT, INSERT, UPDATE, DELETE ON TABLE risk_management.eqms_risk_review_requirment FROM risk_app_user;
