...
BEGIN
    ...
    INSERT INTO dms.eqms_document_variable_mapper (
        eqms_tenant_key, fk_eqms_organization_id, fk_eqms_document_template_variable_id, form_table_name, form_column_name, form_condition, status, created_date, created_by, value_type
    ) VALUES
        (VAR_TENANT_KEY, VAR_ORG_ID, 894, 'eqms_part_lk', 'part_number', NULL, 1, NOW(), 1, NULL),
        (VAR_TENANT_KEY, VAR_ORG_ID, 895, 'eqms_part_lk', 'part_name', NULL, 1, NOW(), 1, NULL),
        (VAR_TENANT_KEY, VAR_ORG_ID, 896, 'eqms_vendors', 'encrypted_vendor_name', NULL, 1, NOW(), 1, NULL),
        (VAR_TENANT_KEY, VAR_ORG_ID, 897, 'eqms_part_lk', 'part_description', NULL, 1, NOW(), 1, 'HTML'),
        (VAR_TENANT_KEY, VAR_ORG_ID, 898, 'eqms_part_lk', 'drawing_number', NULL, 1, NOW(), 1, NULL),
        (VAR_TENANT_KEY, VAR_ORG_ID, 899, 'eqms_bom_assembly_part_details', 'manufacturer_name', NULL, 1, NOW(), 1, NULL),
        (VAR_TENANT_KEY, VAR_ORG_ID, 900, 'eqms_bom_assembly_part_details', 'mfg_part_number', NULL, 1, NOW(), 1, NULL),
        (VAR_TENANT_KEY, VAR_ORG_ID, 901, 'eqms_part_lk', 'part_specification', NULL, 1, NOW(), 1, 'HTML'),
        (VAR_TENANT_KEY, VAR_ORG_ID, 902, 'eqms_purchase_order_part_detail', 'id', '{"id": "@purchase_order_part_detail_id"}', 1, NOW(), 1, NULL),
        (VAR_TENANT_KEY, VAR_ORG_ID, 902, 'eqms_purchase_order', 'id', NULL, 1, NOW(), 1, NULL);
