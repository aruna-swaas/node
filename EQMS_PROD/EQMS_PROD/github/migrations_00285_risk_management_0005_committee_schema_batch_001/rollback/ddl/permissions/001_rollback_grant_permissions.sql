...
REVOKE SELECT, INSERT, UPDATE, DELETE ON TABLE risk_management.eqms_rmp_committee_history FROM risk_app_user;
REVOKE SELECT, INSERT, UPDATE, DELETE ON TABLE risk_management.eqms_rmp_committee FROM risk_app_user;
