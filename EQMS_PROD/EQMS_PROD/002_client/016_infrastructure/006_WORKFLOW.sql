...
(VAR_TENANT_KEY, VAR_ORG_ID, 'RAISE A COMPLAINT', 1, 1, NOW(), 1, 11, 'raise_a_complaint', 29);
...
(VAR_TENANT_KEY, VAR_ORG_ID, 29, 'RAISE A COMPLAINT', 1, 1, 1, NOW(), 1, 0, 113,79);
...
(VAR_TENANT_KEY, VAR_ORG_ID, 29, 'RAISE A COMPLAINT', '{
  "assignmentRule": {
    "assignmentCriteria": {
      "role_id": 6,
      "roleType": "system"
...
}', '{"exitCriteria": {"exitTransitionStatus": [{"conditionalWorkflowStatusId": 84, "conditionalWorkflowStatusName": "Approved"}]}}', 1, NOW(), 1, 105);
...
(VAR_TENANT_KEY, VAR_ORG_ID, 105, 113, 1, NOW(), 1);
...
(VAR_TENANT_KEY, VAR_ORG_ID, 135, 105, 1, NOW(), 1);
...
(VAR_TENANT_KEY, VAR_ORG_ID, 7, 11, 1, 1, NOW(), 1);
...
(VAR_TENANT_KEY, VAR_ORG_ID, 7, 26, 1, NULL, NULL),
(VAR_TENANT_KEY, VAR_ORG_ID, 7, 27, 1, NULL, NULL),
(VAR_TENANT_KEY, VAR_ORG_ID, 7, 28, 1, NULL, NULL),
(VAR_TENANT_KEY, VAR_ORG_ID, 7, 29, 1, NULL, NULL);
...
VALUES
(VAR_TENANT_KEY, VAR_ORG_ID, 92, '{domain}/infrastructure-management/infrastructure-request/{context_instance_id}', 1, NOW(), 1),
(VAR_TENANT_KEY, VAR_ORG_ID, 93, '{domain}/infrastructure-management/infrastructure-qualification/{context_instance_id}', 1, NOW(), 1),
(VAR_TENANT_KEY, VAR_ORG_ID, 94, '{domain}/infrastructure-management/maintenance-report/{context_instance_id}', 1, NOW(), 1),
(VAR_TENANT_KEY, VAR_ORG_ID, 113, '{domain}/infrastructure-management/raise-complaint/{context_instance_id}', 1, NOW(), 1);
