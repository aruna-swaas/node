...
-- Raise a Complaint Form Action Workflow Status Mapping
(VAR_TENANT_KEY, VAR_ORG_ID, 446, NULL, 1, NOW(), 1),
(VAR_TENANT_KEY, VAR_ORG_ID, 447, 81, 1, NOW(), 1),
(VAR_TENANT_KEY, VAR_ORG_ID, 448, 82, 1, NOW(), 1),
(VAR_TENANT_KEY, VAR_ORG_ID, 448, 84, 1, NOW(), 1),
(VAR_TENANT_KEY, VAR_ORG_ID, 449, 83, 1, NOW(), 1),
(VAR_TENANT_KEY, VAR_ORG_ID, 449, 85, 1, NOW(), 1),
(VAR_TENANT_KEY, VAR_ORG_ID, 450, NULL, 1, NOW(), 1),
(VAR_TENANT_KEY, VAR_ORG_ID, 451, 80, 1, NOW(), 1),
(VAR_TENANT_KEY, VAR_ORG_ID, 451, 81, 1, NOW(), 1);
