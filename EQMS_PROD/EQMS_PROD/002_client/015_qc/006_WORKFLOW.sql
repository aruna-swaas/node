...
(VAR_TENANT_KEY, VAR_ORG_ID, 'QC-INCOMING INSPECTION', 1, NOW(), 1,12);
...
(VAR_TENANT_KEY, VAR_ORG_ID, 'INCOMING INSPECTION', 1, 1, NOW(), 1, 12, 'incoming_inspection', 21);
...
(VAR_TENANT_KEY, VAR_ORG_ID, 12, 'Yet to start', 1, NOW(), 1, 1,86,'yet_to_start'),
(VAR_TENANT_KEY, VAR_ORG_ID, 12, 'In Progress', 1, NOW(), 1, 2,87,'in_progress'),
(VAR_TENANT_KEY, VAR_ORG_ID, 12, 'Approved', 1, NOW(), 1, 3,88,'approved'),
(VAR_TENANT_KEY, VAR_ORG_ID, 12, 'Rejected', 1, NOW(), 1, 4,89,'rejected'),
(VAR_TENANT_KEY, VAR_ORG_ID, 12, 'QC Head REJECTED', 1, NOW(), 1, 5,90,'qc_head_rejected');
...
(VAR_TENANT_KEY, VAR_ORG_ID, 12, 86, 87, 1, NOW(), 1, 1,98),
(VAR_TENANT_KEY, VAR_ORG_ID, 12, 87, 88, 1, NOW(), 1, 3,99),
(VAR_TENANT_KEY, VAR_ORG_ID, 12, 87, 89, 1, NOW(), 1, 3,100),
(VAR_TENANT_KEY, VAR_ORG_ID, 12, 89, 88, 1, NOW(), 1, 3,101),
(VAR_TENANT_KEY, VAR_ORG_ID, 12, 89, 90, 1, NOW(), 1, 3,102);
...
(VAR_TENANT_KEY, VAR_ORG_ID, 98, 6, 1, NOW(), 1),
(VAR_TENANT_KEY, VAR_ORG_ID, 98, 8, 1, NOW(), 1),
(VAR_TENANT_KEY, VAR_ORG_ID, 99, 6, 1, NOW(), 1),
(VAR_TENANT_KEY, VAR_ORG_ID, 99, 8, 1, NOW(), 1),
(VAR_TENANT_KEY, VAR_ORG_ID, 100, 6, 1, NOW(), 1),
(VAR_TENANT_KEY, VAR_ORG_ID, 100, 8, 1, NOW(), 1),
(VAR_TENANT_KEY, VAR_ORG_ID, 101, 8, 1, NOW(), 1),
(VAR_TENANT_KEY, VAR_ORG_ID, 102, 8, 1, NOW(), 1);
...
VALUES
(VAR_TENANT_KEY, VAR_ORG_ID, 55, '{domain}/quality-control-management/incoming-inspection/{context_instance_id}', 1, NOW(), 1);
